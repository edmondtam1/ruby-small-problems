...
frankenstein_text = 'St. Petersburgh, Dec. 11th, 17—.
...
# to find longest paragraph, we can use '.\n' || '!\n' || '?\n' in the if conditional
# to find longest word, we just iterate through each word and replace longest when it fits
